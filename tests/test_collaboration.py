...
def sample_cases():
    ...
    return [
        {"user_input": "login with valid creds", "expected": "success"},
        {"user_input": "login with invalid creds", "expected": "error"},
    ]
...
def mock_scenario():
    ...
    class MockCase:
        def __init__(self, user_input, expected, context=None, metadata=None):
