...
def test_adversarial_augmenter():
    ...
    from agentunit.generators.augmentation import AdversarialAugmenter
...
def test_noise_augmenter():
    """Test NoiseAugmenter."""
    from agentunit.generators.augmentation import NoiseAugmenter
...
def test_edge_case_generator():
    ...
    from agentunit.generators.augmentation import EdgeCaseGenerator
...
def test_distribution_shifter():
    ...
    from agentunit.generators.augmentation import DistributionShifter
...
def test_prompt_template():
    """Test PromptTemplate."""
    from agentunit.generators.templates import PromptTemplate
...
def test_dataset_template():
    ...
    from agentunit.generators.templates import DatasetTemplate, get_template, list_templates
...
def test_generator_config():
    ...
    assert config.edge_case_ratio == 0.4
