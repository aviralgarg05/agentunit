...
class MultimodalAdapter:
    ...
    def __init__(self, model: str = "gpt-4o", api_key: str | None = None):
        ...
        if not HAS_OPENAI:
            msg = "OpenAI package required for MultimodalAdapter. Install with: pip install openai"
    ...
    def prepare_messages(self, multimodal_input: MultimodalInput) -> list[dict[str, Any]]:
        ...
        if multimodal_input.image_url:
            content.append({"type": "image_url", "image_url": {"url": multimodal_input.image_url}})
...
class VisionAdapter(MultimodalAdapter):
    ...
    def __init__(self, model: str = "gpt-4o", use_clip: bool = True, api_key: str | None = None):
    ...
    def get_clip_embedding(self, image_path: str) -> torch.Tensor | None:
    ...
    def get_text_embedding(self, text: str) -> torch.Tensor | None:
    ...
    def compute_similarity(self, image_path: str, text: str) -> float | None:
