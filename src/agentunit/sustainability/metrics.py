...
class EnergyMetric:
    ...
    def __init__(self, threshold_kwh: float = 0.1, sample_interval: float = 1.0):
...
class CarbonMetric:
    ...
    def __init__(self, threshold_kg: float = 0.05, grid_intensity: float = 0.475):
    ...
    def evaluate(self, case: DatasetCase, trace: TraceLog, outcome: Any) -> MetricResult:
        ...
        return MetricResult(
            ...
            detail={
                ...
                "equivalents": {"km_driven": km_driven, "trees_needed": trees_needed},
            },
        )
...
class ResourceUtilizationMetric:
    ...
    def evaluate(self, case: DatasetCase, trace: TraceLog, outcome: Any) -> MetricResult:
        ...
        memory_score = self._score_utilization(memory_gb, self.target_memory_gb, is_absolute=True)
    ...
    def _score_utilization(self, actual: float, target: float, is_absolute: bool = False) -> float:
