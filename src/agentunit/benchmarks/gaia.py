...
class GAIABenchmark:
    ...
    def __init__(self, dataset_path: Path | None = None, level: GAIALevel | None = None):
        ...
        with open(dataset_file) as f:
            for line in f:
                ...
                task = GAIATask(
                    ...
                    file_path=self.dataset_path / data["file_name"]
    ...
    def format_submission(
        self, results: list[dict[str, Any]], model_name: str = "custom_model"
    ) -> dict[str, Any]:
        ...
        """
        submission = {"model_name": model_name, "results": []}
    ...
    def calculate_score(self, results: list[dict[str, Any]]) -> dict[str, float]:
        ...
        """
        scores = {"overall": 0.0, "level_1": 0.0, "level_2": 0.0, "level_3": 0.0}

        counts = {"overall": 0, "level_1": 0, "level_2": 0, "level_3": 0}
