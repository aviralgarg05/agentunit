...
class SwarmAdapter(MultiAgentAdapter):
    ...
    def __init__(self, client_config: dict[str, Any] | None = None, **kwargs):
    ...
    def _create_message_interaction(
        self, session_id: SessionID, message: dict, current_agent: str
    ) -> None:
    ...
    def _track_agent_handoffs(
        self, session_id: SessionID, response: Any, current_agent: str
    ) -> None:
    ...
    def _process_swarm_response(
        self, session_id: SessionID, response: Any, initial_agent_id: str
    ) -> None:
    ...
    def send_message(self, session_id: SessionID, content: str, **kwargs) -> bool:
    ...
    def _analyze_function_usage(self, function_calls: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    def _analyze_handoff_patterns(self, handoffs: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    def _calculate_agent_utilization(self, session_id: SessionID) -> dict[str, float]:
        ...
        total_interactions = len(session_interactions)
        return {agent_id: count / total_interactions for agent_id, count in agent_counts.items()}
